...
export function SelectionPanel() {
  ...
  const detailApplicant = useMemo(
    () => applicants.find((a) => a.id === detailId),
    [applicants, detailId]
  );
  const startTestApplicant = useMemo(
    () => applicants.find((a) => a.id === startTestId),
    [applicants, startTestId]
  );
  ...
  const estadoToBadge = (estado) => {
    ...
    if (estado === "En Prueba")
      return { variant: "purple", label: "En Prueba" };
    if (estado === "Aprobado") return { variant: "success", label: "Aprobado" };
    return { variant: "neutral", label: estado };
  };

  const etapaToBadge = (etapa) => {
    if (etapa === "Formulario Enviado")
      return { variant: "success", label: "Formulario Enviado" };
    if (etapa === "Prueba Técnica")
      return { variant: "info", label: "Prueba Técnica" };
    if (etapa === "Entrevista")
      return { variant: "purple", label: "Entrevista" };
      ...
      <div className="w-full">
        <div className="mb-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Gestiona el Proceso completo de Selección de Practicantes Senati
            </p>
          </div>
        ...
        <div className="space-y-3">
          <div className="flex justify-end mb-1">
            <Button
              variant="dark"
              className="h-9 px-5 rounded-full text-sm font-medium flex items-center justify-center text-white"
              type="button"
              style={{ color: "#fff" }}
            >
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center justify-center gap-2">
                              ...
                              <button
                                ...
                                className="h-9 w-9 rounded-full flex items-center justify-center bg-white border border-gray-300 text-gray-700 hover:bg-gray-50"
                                onClick={() => {
                                  /* TODO: implementar eliminación de postulante */
                                }}
        ...
        <Modal
          ...
          containerClassName="w-[520px] h-[700px] max-w-[95vw]"
          footer={
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <Badge
                          variant={
                            detailApplicant.estado === "Aprobado"
                              ? "success"
                              : detailApplicant.estado === "En Prueba"
                              ? "purple"
                              : detailApplicant.estado === "Pendiente"
                              ? "warning"
                              : "neutral"
                          }
                        >
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <Badge
                          variant={
                            detailApplicant.etapa === "Formulario Enviado"
                              ? "success"
                              : detailApplicant.etapa === "Prueba Técnica"
                              ? "info"
                              : detailApplicant.etapa === "Entrevista"
                              ? "purple"
                              : "neutral"
                          }
                        >
              ...
              <div className="flex-1 mt-6 md:mt-0 md:pl-6">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="font-medium text-gray-800">
                      {detailApplicant.fechaPostulacion}
                    </div>
                  </div>
                </div>
              </div>
        ...
        <Modal
          ...
          footer={
            <>
              <Button variant="light" onClick={closeStartTest}>
                Cancelar
              </Button>
              <Button variant="success" onClick={closeStartTest}>
                Confirmar
              </Button>
            </>
          }
        >
          {startTestApplicant && (
            <p>
              ¿Deseas iniciar la prueba técnica para {startTestApplicant.nombre}
              ?
            </p>
          )}
        </Modal>
